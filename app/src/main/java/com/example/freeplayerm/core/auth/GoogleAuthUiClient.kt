...
class GoogleAuthUiClient(
    ...
    suspend fun iniciarSesion(): SignInResult {
        // IMPORTANTE: Este debe ser el WEB Client ID de Google Cloud Console, no el Android Client
        // ID
        val serverClientId =
            "1055393121843-p1ob2qacorbvq5kk5ojmgu73n3s0mjrv.apps.googleusercontent.com"
        ...
        return try {
            ...
            if (
                ...
                val usuarioFirebase =
                    auth.signInWithCredential(credencialFirebase).await().user
