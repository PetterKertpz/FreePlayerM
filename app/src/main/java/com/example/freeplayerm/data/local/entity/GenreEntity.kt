// en: app/src/main/java/com/example/freeplayerm/data/local/entity/GenreEntity.kt
 ...
 *
 * Entidad que representa un género musical Incluye información descriptiva, icono y estadísticas
 *
 * Características:
...
data class GenreEntity(
    @PrimaryKey(autoGenerate = true) @ColumnInfo(name = "id_genero") val idGenero: Int = 0,
    ...
    @ColumnInfo(name = "color") val color: String? = null, // Color en formato hexadecimal (#RRGGBB)
    @ColumnInfo(name = "emoji")
    val emoji: String? = null, // Emoji representativo (🎸, 🎹, 🎤, etc.)
    @ColumnInfo(name = "icono_url") val iconoUrl: String? = null,
    @ColumnInfo(name = "icono_path_local") val iconoPathLocal: String? = null,

    // ==================== ESTADÍSTICAS ====================

    @ColumnInfo(name = "total_canciones") val totalCanciones: Int = 0,
    @ColumnInfo(name = "total_artistas") val totalArtistas: Int = 0,
    @ColumnInfo(name = "total_albumes") val totalAlbumes: Int = 0,
    @ColumnInfo(name = "total_reproducciones") val totalReproducciones: Int = 0,

    // ==================== CLASIFICACIÓN ====================

    @ColumnInfo(name = "es_popular") val esPopular: Boolean = false, // Si es un género popular
