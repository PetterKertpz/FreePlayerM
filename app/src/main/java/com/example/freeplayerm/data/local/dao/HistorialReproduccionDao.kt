...
import com.example.freeplayerm.data.local.entity.HistorialReproduccionEntity
 ...
 */
@Dao
interface HistorialReproduccionDao {
    ...
    @Update
    suspend fun actualizarHistorial(historial: HistorialReproduccionEntity): Int
    ...
    """)
    suspend fun actualizarDuracionReproducida(
        id: Int,
        duracion: Int,
        completo: Boolean
    ): Int
    ...
    @Delete
    suspend fun eliminarHistorial(historial: HistorialReproduccionEntity): Int
    ...
    """)
    suspend fun eliminarHistorialAntiguoDelUsuario(
        usuarioId: Int,
        fechaLimite: Int
    ): Int
    ...
    suspend fun obtenerHistorialPorId(id: Int): HistorialReproduccionEntity?
    ...
    """)
    fun obtenerHistorialDelUsuario(usuarioId: Int): Flow<List<HistorialReproduccionEntity>>
    ...
    @Query("""
        ...
        LIMIT :limite
    """)
    fun obtenerHistorialReciente(usuarioId: Int, limite: Int = 50): Flow<List<HistorialReproduccionEntity>>
    ...
    @Query("""
        ...
        ORDER BY fecha_reproduccion DESC
    """)
    fun obtenerHistorialDeCancion(
        usuarioId: Int,
        cancionId: Int
    ): Flow<List<HistorialReproduccionEntity>>
    ...
    @Query("""
        ...
        WHERE id_usuario = :usuarioId 
          ...
          AND completo = 1
    """)
    suspend fun contarReproduccionesCompletasDeCancion(
        usuarioId: Int,
        cancionId: Int
    ): Int
    ...
    @Query("""
        ...
        ORDER BY fecha_reproduccion DESC
    """)
    fun obtenerHistorialDeHoy(usuarioId: Int, timestampHoy: Int): Flow<List<HistorialReproduccionEntity>>
    ...
    @Query("""
        ...
        LIMIT :cantidad
    """)
    suspend fun obtenerHistorialAleatorio(usuarioId: Int, cantidad: Int): List<HistorialReproduccionEntity>
