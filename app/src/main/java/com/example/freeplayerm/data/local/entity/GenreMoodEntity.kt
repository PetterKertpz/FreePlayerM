 ...
 *
 * Relaciones:
 * - N:1 con GenreEntity (un género puede tener múltiples moods)
 *
 * Casos de uso:
...
data class GenreMoodEntity(
    @PrimaryKey(autoGenerate = true) @ColumnInfo(name = "id_mood") val idMood: Int = 0,
    ...
    /**
     * Nombre del mood o característica Ejemplos: "energetic", "melancholic", "aggressive",
     * "romantic", "chill"
     */
    @ColumnInfo(name = "mood") val mood: String,

    /**
     * Intensidad del mood en este género Rango: 0.0 (nada presente) a 1.0 (muy presente)
     *
     * Ejemplo: Rock podría tener "energetic" = 0.9, "sad" = 0.3
     */
    @ColumnInfo(name = "intensidad") val intensidad: Float,

    // ==================== TIPO DE CARACTERÍSTICA ====================

    /**
     * Tipo de característica Valores: MOOD, ENERGIA, TEMPO, VALENCIA, ACUSTICA, INSTRUMENTAL,
     * DANCEABILITY
     */
    @ColumnInfo(name = "tipo") val tipo: String = "MOOD",
    ...
    /** Tags adicionales relacionados (JSON array) Ejemplo: ["party", "workout", "study"] */
    @ColumnInfo(name = "tags_json") val tagsJson: String? = null,

    // ==================== METADATOS TÉCNICOS ====================

    /**
     * Rango de tempo promedio para este mood en este género (BPM) JSON: {"min": 120, "max": 140}
     */
    @ColumnInfo(name = "tempo_range_json") val tempoRangeJson: String? = null,

    /** Nivel de energía musical (0.0-1.0) Basado en análisis de Spotify/MusicBrainz */
    @ColumnInfo(name = "energia") val energia: Float? = null,

    /** Valencia (positividad) (0.0-1.0) 0.0 = muy negativo/triste, 1.0 = muy positivo/feliz */
    @ColumnInfo(name = "valencia") val valencia: Float? = null,

    /** Danceabilidad (0.0-1.0) Qué tan bailable es este mood del género */
    @ColumnInfo(name = "danceability") val danceability: Float? = null,

    /** Nivel acústico (0.0-1.0) 0.0 = totalmente electrónico, 1.0 = totalmente acústico */
    @ColumnInfo(name = "acustica") val acustica: Float? = null,

    /** Nivel instrumental (0.0-1.0) 0.0 = muchas voces, 1.0 = totalmente instrumental */
    @ColumnInfo(name = "instrumental") val instrumental: Float? = null,

    // ==================== CONTEXTO DE USO ====================

    /**
     * Momentos del día recomendados (JSON array) Ejemplo:
     * ["morning", "afternoon", "night", "late_night"]
     */
    @ColumnInfo(name = "momentos_dia_json") val momentosDiaJson: String? = null,

    /**
     * Actividades recomendadas (JSON array) Ejemplo:
     * ["workout", "study", "party", "relax", "sleep", "drive"]
     */
    @ColumnInfo(name = "actividades_json") val actividadesJson: String? = null,

    // ==================== METADATOS ====================

    /** Fuente de los datos Valores: "SPOTIFY", "MUSICBRAINZ", "MANUAL", "ML_MODEL" */
    @ColumnInfo(name = "fuente") val fuente: String = "MANUAL",

    /** Confianza en la clasificación (0.0-1.0) Útil si se usa ML para clasificar */
    @ColumnInfo(name = "confianza") val confianza: Float = 1.0f,
