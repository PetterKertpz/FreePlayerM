// en: app/src/main/java/com/example/freeplayerm/data/local/entity/DetalleListaReproduccionEntity.kt
 ...
 *
 * Entidad que representa la relación muchos a muchos entre listas y canciones
 * Incluye campo de orden para mantener la secuencia de canciones en la lista
 *
 * Características:
...
data class DetalleListaReproduccionEntity(
    ...
    companion object {
        ...
        fun crear(
            ...
            return DetalleListaReproduccionEntity(
                idLista = idLista,
                idCancion = idCancion,
                orden = ordenActual,
