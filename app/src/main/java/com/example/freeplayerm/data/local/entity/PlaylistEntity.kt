// en: app/src/main/java/com/example/freeplayerm/data/local/entity/PlaylistEntity.kt
 ...
 *
 * Entidad que representa una playlist o lista de reproducción Incluye metadata, permisos y
 * estadísticas
 *
 * Características:
...
data class PlaylistEntity(
    @PrimaryKey(autoGenerate = true) @ColumnInfo(name = "id_lista") val idLista: Int = 0,
    ...
    @ColumnInfo(name = "portada_url") val portadaUrl: String? = null,
    ...
    @ColumnInfo(name = "duracion_total_segundos") val duracionTotalSegundos: Int = 0,
    @ColumnInfo(name = "veces_reproducida") val vecesReproducida: Int = 0,
    @ColumnInfo(name = "ultima_reproduccion") val ultimaReproduccion: Int? = null,

    // ==================== METADATA ====================

    @ColumnInfo(name = "categoria") val categoria: String? = null, // Workout, Relax, Party, etc.
    ...
    companion object {
        ...
        val listasDelSistema =
            listOf("Favoritos", "Recientes", "Más Reproducidas", "Mi Mix", "Descubrimiento Semanal")
