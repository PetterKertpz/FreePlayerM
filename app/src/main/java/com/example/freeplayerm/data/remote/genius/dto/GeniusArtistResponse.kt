...
fun ArtistDetails.getSocialMediaLinks(): Map<String, String> {
    ...
    facebookName?.takeIf { !links.containsKey("facebook") }?.let {
        links["facebook"] = "https://facebook.com/$it"
    }
    instagramName?.takeIf { !links.containsKey("instagram") }?.let {
        links["instagram"] = "https://instagram.com/$it"
    }
    twitterName?.takeIf { !links.containsKey("twitter") }?.let {
        links["twitter"] = "https://twitter.com/$it"
    }
