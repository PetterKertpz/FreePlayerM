// en: app/src/main/java/com/example/freeplayerm/data/local/entity/UserEntity.kt
...
data class UserEntity(
   ...
   @ColumnInfo(name = "nombre_completo") val nombreCompleto: String? = null,
   ...
   @ColumnInfo(name = "ultima_sesion") val ultimaSesion: Long? = null, // Timestamp de última sesión

   // ==================== TOKENS DE SESIÓN ====================

   @ColumnInfo(name = "token_sesion") val tokenSesion: String? = null,
   @ColumnInfo(name = "refresh_token") val refreshToken: String? = null,
   @ColumnInfo(name = "token_expiracion") val tokenExpiracion: Long? = null,
   @ColumnInfo(name = "salt") val salt: String? = null, // Salt adicional si se usa otro algoritmo
   @ColumnInfo(name = "ultimo_cambio_contrasena") val ultimoCambioContrasena: Long? = null,
   @ColumnInfo(name = "fecha_creacion") val fechaCreacion: Long = 0L, // Timestamp de cuándo se creó
   ...
   @ColumnInfo(name = "reproduccion_automatica") val reproduccionAutomatica: Boolean = true,
   @ColumnInfo(name = "calidad_preferida")
   val calidadPreferida: String = CALIDAD_ALTA, // LOW, MEDIUM, HIGH
   @ColumnInfo(name = "idioma_preferido") val idiomaPreferido: String = "es", // es, en, fr, etc.

   // ==================== ESTADÍSTICAS ====================

   @ColumnInfo(name = "total_reproducciones") val totalReproducciones: Int = 0,
   @ColumnInfo(name = "total_favoritos") val totalFavoritos: Int = 0,
   @ColumnInfo(name = "total_listas") val totalListas: Int = 0,
) {
