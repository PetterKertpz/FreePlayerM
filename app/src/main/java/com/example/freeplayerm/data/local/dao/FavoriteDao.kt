...
interface FavoriteDao {
    ...
    suspend fun insertarFavorito(favorito: FavoriteEntity): Long

    @Insert(onConflict = OnConflictStrategy.REPLACE)
    suspend fun insertarFavoritos(favoritos: List<FavoriteEntity>): List<Long>

    // ==================== ACTUALIZACIÓN ====================

    @Update suspend fun actualizarFavorito(favorito: FavoriteEntity): Int
    ...
    suspend fun actualizarCalificacion(usuarioId: Int, cancionId: Int, calificacion: Float): Int
    ...
    suspend fun actualizarNotas(usuarioId: Int, cancionId: Int, notas: String?): Int
    ...
    suspend fun actualizarOrden(usuarioId: Int, cancionId: Int, nuevoOrden: Int): Int
    ...
    suspend fun incrementarReproduccionesDesdeFavoritos(usuarioId: Int, cancionId: Int): Int

    // ==================== ELIMINACIÓN ====================

    @Delete suspend fun eliminarFavorito(favorito: FavoriteEntity): Int
    ...
    suspend fun obtenerFavorito(usuarioId: Int, cancionId: Int): FavoriteEntity?
    ...
    fun obtenerFavoritosDelUsuario(usuarioId: Int): Flow<List<FavoriteEntity>>
    ...
    suspend fun obtenerFavoritosDelUsuarioSync(usuarioId: Int): List<FavoriteEntity>
    ...
    fun obtenerCancionesFavoritasConDetalles(usuarioId: Int): Flow<List<SongWithArtist>>
    ...
    fun obtenerCancionesFavoritasOrdenadas(usuarioId: Int): Flow<List<SongWithArtist>>
    ...
    fun obtenerFavoritosRecientes(usuarioId: Int, limite: Int = 20): Flow<List<FavoriteEntity>>
    ...
    fun obtenerFavoritosMejorCalificados(
        usuarioId: Int,
        limite: Int = 20,
    ...
    fun obtenerFavoritosMasReproducidos(
        usuarioId: Int,
        limite: Int = 20,
    ): Flow<List<FavoriteEntity>>
    ...
    fun obtenerFavoritosConOrdenPersonalizado(usuarioId: Int): Flow<List<FavoriteEntity>>
    ...
    fun obtenerFavoritosConNotas(usuarioId: Int): Flow<List<FavoriteEntity>>
    ...
    suspend fun contarFavoritosConCalificacion(usuarioId: Int, calificacion: Float): Int
    ...
    suspend fun toggleFavorito(usuarioId: Int, cancionId: Int): Boolean {
        return if (esFavorita(usuarioId, cancionId)) {
            ...
            insertarFavorito(FavoriteEntity.crear(usuarioId, cancionId))
            true // Se agregó
        }
    }
    ...
    suspend fun toggleFavoritoConCalificacion(
        ...
        return if (esFavorita(usuarioId, cancionId)) {
            ...
            insertarFavorito(
                FavoriteEntity.crearConCalificacion(usuarioId, cancionId, calificacion)
            )
            true
        }
    }
    ...
    suspend fun reordenarFavoritos(usuarioId: Int, nuevosOrdenes: Map<Int, Int>) {
        nuevosOrdenes.forEach { (cancionId, orden) -> actualizarOrden(usuarioId, cancionId, orden) }
    }
    ...
    @Transaction
    suspend fun obtenerOCrearFavorito(usuarioId: Int, cancionId: Int): FavoriteEntity {
        return obtenerFavorito(usuarioId, cancionId)
            ?: run {
                val nuevo = FavoriteEntity.crear(usuarioId, cancionId)
