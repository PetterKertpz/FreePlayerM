 ...
 *
 * Reemplaza los campos hardcodeados (instagram, twitter, facebook, youtube)
 * de ArtistaEntity con una tabla escalable.
 *
 * Relaciones:
 * - N:1 con ArtistaEntity (un artista puede tener múltiples redes sociales)
 *
 * Casos de uso:
...
data class RedesSocialesArtistaEntity(
    @PrimaryKey(autoGenerate = true)
    @ColumnInfo(name = "id_red_social")
    val idRedSocial: Int = 0,
     ...
     * Valores: INSTAGRAM, TWITTER, FACEBOOK, YOUTUBE, TIKTOK, SPOTIFY,
    ...
    /**
     * Username o handle del artista
     * Ejemplo: "@badgyal" (puede incluir @ o no)
     */
    ...
    /**
     * Cantidad de seguidores/suscriptores
     * null si no está disponible
     */
    @ColumnInfo(name = "seguidores")
    val seguidores: Int? = null,

    /**
     * Cantidad de publicaciones/posts
     */
    @ColumnInfo(name = "publicaciones")
    val publicaciones: Int? = null,

    // ==================== CONTROL ====================

    /**
     * Si el enlace sigue siendo válido
     * Se marca como false si se detecta 404 o cuenta eliminada
     */
    @ColumnInfo(name = "activa")
    val activa: Boolean = true,

    /**
     * Si es la red social principal del artista
     * Útil para mostrar primero o destacar
     */
