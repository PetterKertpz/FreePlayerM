 ...
 *
 * Entidad que representa una canción en la base de datos Incluye metadatos, referencias a
 * artista/álbum/género, y estadísticas de reproducción
 *
 * Características:
...
data class SongEntity(
    ...
    @ColumnInfo(name = "numero_pista") val numeroPista: Int? = null, // Número de pista en el álbum
    @ColumnInfo(name = "anio") val anio: Int? = null, // Año de lanzamiento

    // ==================== ORIGEN Y ARCHIVO ====================

    @ColumnInfo(name = "origen") val origen: String, // "LOCAL", "REMOTA", "STREAMING"
    ...
    /** Título completo con artistas featured Mapea desde: SongDetailsEnhanced.titleWithFeatured */
    @ColumnInfo(name = "titulo_completo") val tituloCompleto: String? = null,

    /** Estado de la letra en Genius Valores: "complete", "incomplete", null */
    ...
    /** Idioma de la letra Mapea desde: SongDetailsEnhanced.language */
    @ColumnInfo(name = "idioma") val idioma: String? = null,

    /** Ubicación de grabación Mapea desde: SongDetailsEnhanced.recordingLocation */
    @ColumnInfo(name = "ubicacion_grabacion") val ubicacionGrabacion: String? = null,

    /**
     * IDs externos (Spotify, Apple Music, YouTube) Almacena JSON: {"spotify": "id", "youtube":
     * "url", ...}
     */
    ...
    @ColumnInfo(name = "bitrate") val bitrate: Int? = null, // Bitrate en kbps
