// en: app/src/main/java/com/example/freeplayerm/data/local/entity/FavoriteEntity.kt
...
data class FavoriteEntity(
    ...
    @ColumnInfo(name = "notas") val notas: String? = null, // Notas personales sobre la canción
) {
    ...
    companion object {
        ...
        fun crear(idUsuario: Int, idCancion: Int): FavoriteEntity {
            return FavoriteEntity(idUsuario = idUsuario, idCancion = idCancion)
        }
