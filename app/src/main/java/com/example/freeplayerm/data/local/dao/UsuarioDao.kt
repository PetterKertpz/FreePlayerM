...
interface UsuarioDao {
    ...
    suspend fun obtenerUsuarioPorToken(token: String): UsuarioEntity?
     ...
     * REEMPLAZA al método autenticarUsuario anterior
     */
    @Query("""
        SELECT * FROM usuarios 
        ...
        LIMIT 1
    """)
    suspend fun obtenerUsuarioParaAutenticar(identificador: String): UsuarioEntity?
