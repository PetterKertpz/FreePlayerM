 ...
 * 🔗 MEDIA LINKS ENTITY
 *
 * Almacena enlaces externos a plataformas de música/video para canciones, álbumes y artistas.
 *
 * Casos de uso:
...
data class MediaLinksEntity(
    @PrimaryKey(autoGenerate = true) @ColumnInfo(name = "id_link") val idLink: Int = 0,

    // Relación polimórfica (puede ser canción, álbum o artista)
    @ColumnInfo(name = "tipo_recurso") val tipoRecurso: String, // CANCION, ALBUM, ARTISTA
    @ColumnInfo(name = "id_recurso") val idRecurso: Int, // ID de la entidad relacionada

    // Compatibilidad con FKs específicas
    @ColumnInfo(name = "id_cancion") val idCancion: Int? = null,
    @ColumnInfo(name = "id_album") val idAlbum: Int? = null,
    @ColumnInfo(name = "id_artista") val idArtista: Int? = null,

    // ==================== INFORMACIÓN DEL LINK ====================

    @ColumnInfo(name = "plataforma") val plataforma: String, // SPOTIFY, YOUTUBE, APPLE_MUSIC, etc.
    @ColumnInfo(name = "url") val url: String,
    @ColumnInfo(name = "external_id") val externalId: String? = null, // ID en la plataforma externa
    @ColumnInfo(name = "tipo_link")
    val tipoLink: String = "STREAMING", // STREAMING, VIDEO, SOCIAL, PURCHASE

    // ==================== METADATOS ====================

    @ColumnInfo(name = "disponible") val disponible: Boolean = true,
