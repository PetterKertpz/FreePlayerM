// en: app/src/main/java/com/example/freeplayerm/data/local/entity/SongArtistCrossRef.kt
 ...
 *
 * Entidad que representa la relación muchos a muchos entre canciones y artistas Permite que una
 * canción tenga múltiples artistas (colaboraciones, features, remixes)
 *
 * Características:
...
data class SongArtistCrossRef(
    ...
    @ColumnInfo(name = "fuente") val fuente: String = FUENTE_LOCAL, // De dónde se obtuvo la info
    ...
    /** Obtiene el prefijo para mostrar según el tipo Ejemplo: "feat.", "remix by", "prod. by" */
    ...
    companion object {
        ...
        fun crearPrincipal(idCancion: Int, idArtista: Int): SongArtistCrossRef {
            return SongArtistCrossRef(
                idCancion = idCancion,
                idArtista = idArtista,
        ...
        /** Crea un featuring */
        fun crearFeaturing(idCancion: Int, idArtista: Int, orden: Int = 1): SongArtistCrossRef {
            return SongArtistCrossRef(
                idCancion = idCancion,
                idArtista = idArtista,
        ...
        /** Crea un remixer */
        fun crearRemixer(idCancion: Int, idArtista: Int): SongArtistCrossRef {
            return SongArtistCrossRef(
                idCancion = idCancion,
                idArtista = idArtista,
        ...
        /** Crea un productor */
        fun crearProductor(idCancion: Int, idArtista: Int): SongArtistCrossRef {
            return SongArtistCrossRef(
                idCancion = idCancion,
                idArtista = idArtista,
        ...
        /**
         * Parsea un string de artistas y crea las entidades Ejemplo: "Artist A feat. Artist B,
         * Artist C"
         *
         * @return Lista de SongArtistCrossRef sin IDs asignados (usar después de insertar artistas)
         */
        fun parsearArtistasDeTexto(
            texto: String,
            idCancion: Int,
            mapaArtistas: Map<String, Int>, // nombre -> id
        ): List<SongArtistCrossRef> {
            val resultado = mutableListOf<SongArtistCrossRef>()
            ...
            artistaPrincipal.let { nombre ->
                mapaArtistas[nombre]?.let { id -> resultado.add(crearPrincipal(idCancion, id)) }
            }
