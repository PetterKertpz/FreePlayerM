// en: app/src/main/java/com/example/freeplayerm/data/local/entity/EstadisticasModels.kt
package com.example.freeplayerm.data.local.entity

import androidx.room.ColumnInfo

/**
 * Data class para estadísticas de top elementos (artistas, géneros, etc.)
 * Usado en queries de ranking
 */
...
/**
 * Data class para estadísticas generales de la biblioteca musical
 * Contiene totales agregados de todos los elementos
 */
