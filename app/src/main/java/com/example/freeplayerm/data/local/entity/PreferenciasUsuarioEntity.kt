// en: app/src/main/java/com/example/freeplayerm/data/local/entity/PreferenciasUsuarioEntity.kt
 ...
 *
 * Entidad que almacena las preferencias y configuración de cada usuario
 * Separada de UsuarioEntity para mejor organización y performance
 *
 * Características:
 ...
 *
 * Ventajas de separar:
 * - UsuarioEntity más ligero para autenticación
...
data class PreferenciasUsuarioEntity(
    @PrimaryKey
    ...
    @ColumnInfo(name = "tema_color")
    val temaColor: String? = null, // Color primario del tema (hex)

    @ColumnInfo(name = "usar_colores_portada")
    val usarColoresPortada: Boolean = true, // Extraer colores de portadas

    @ColumnInfo(name = "animaciones_habilitadas")
    val animacionesHabilitadas: Boolean = true,

    @ColumnInfo(name = "mostrar_letras_automatico")
    val mostrarLetrasAutomatico: Boolean = false,
    ...
    @ColumnInfo(name = "solo_wifi_descarga")
    val soloWifiDescarga: Boolean = true,
    ...
    @ColumnInfo(name = "notificar_nuevos_albumes")
    val notificarNuevosAlbumes: Boolean = true,

    @ColumnInfo(name = "notificar_recomendaciones")
    val notificarRecomendaciones: Boolean = true,

    @ColumnInfo(name = "sonido_notificacion")
    val sonidoNotificacion: Boolean = false,

    @ColumnInfo(name = "vibracion_notificacion")
    val vibracionNotificacion: Boolean = false,

    // ==================== IDIOMA Y REGIÓN ====================

    @ColumnInfo(name = "idioma_preferido")
    val idiomaPreferido: String = "es", // Código ISO 639-1

    @ColumnInfo(name = "formato_fecha")
    val formatoFecha: String = "DD/MM/YYYY",

    @ColumnInfo(name = "formato_hora")
    val formatoHora: String = "24H", // "12H" o "24H"
    ...
    @ColumnInfo(name = "sincronizar_listas")
    val sincronizarListas: Boolean = true,

    @ColumnInfo(name = "sincronizar_historial")
    val sincronizarHistorial: Boolean = true,

    @ColumnInfo(name = "backup_automatico")
    ...
    @ColumnInfo(name = "auto_descargar_portadas")
    val autoDescargarPortadas: Boolean = true,

    @ColumnInfo(name = "auto_descargar_letras")
    val autoDescargarLetras: Boolean = true,
    ...
    @ColumnInfo(name = "gestos_habilitados")
    val gestosHabilitados: Boolean = true,
    ...
    val botonVolumenCambiarCancion: Boolean = false, // Usar botones de volumen cuando pantalla apagada
    ...
    @ColumnInfo(name = "bluetooth_auto_play")
    val bluetoothAutoPlay: Boolean = true,

    // ==================== AVANZADO ====================

    @ColumnInfo(name = "cache_size_mb")
    val cacheSizeMb: Int = 500, // Tamaño máximo de cache en MB

    @ColumnInfo(name = "buffer_size_ms")
    val bufferSizeMs: Int = 15000, // Buffer de streaming en ms

    @ColumnInfo(name = "logs_habilitados")
    val logsHabilitados: Boolean = false, // Para debugging

    @ColumnInfo(name = "modo_desarrollador")
    val modoDesarrollador: Boolean = false,
     ...
     */
    fun tieneEcualizador(): Boolean = !ecualizadorPreset.isNullOrBlank() || !ecualizadorCustomJson.isNullOrBlank()
    ...
    companion object {
         ...
         */
        fun crearPorDefecto(idUsuario: Int): PreferenciasUsuarioEntity {
            return PreferenciasUsuarioEntity(idUsuario = idUsuario)
        }

        /**
         * Crea preferencias optimizadas para ahorro de datos
         */
        fun crearModoAhorro(idUsuario: Int): PreferenciasUsuarioEntity {
            return PreferenciasUsuarioEntity(
                idUsuario = idUsuario,
         ...
         */
        fun crearModoAudiofilo(idUsuario: Int): PreferenciasUsuarioEntity {
            return PreferenciasUsuarioEntity(
                idUsuario = idUsuario,
