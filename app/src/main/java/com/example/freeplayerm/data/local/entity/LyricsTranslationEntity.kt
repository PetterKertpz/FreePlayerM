 ...
 *
 * Relaciones:
 * - N:1 con LyricsEntity (una letra puede tener múltiples traducciones)
 *
 * Casos de uso:
...
data class LyricsTranslationEntity(
    @PrimaryKey(autoGenerate = true) @ColumnInfo(name = "id_traduccion") val idTraduccion: Int = 0,
    ...
    /** Código ISO 639-1 del idioma Ejemplos: es, en, fr, de, pt, it, ja, ko, zh */
    @ColumnInfo(name = "idioma") val idioma: String,
    @ColumnInfo(name = "nombre_idioma") val nombreIdioma: String, // "Español", "English", etc.

    // ==================== CONTENIDO ====================

    @ColumnInfo(name = "texto_traducido") val textoTraducido: String,

    // ==================== FUENTE Y VERIFICACIÓN ====================

    /**
     * Fuente de la traducción Valores: "GENIUS", "MUSIXMATCH", "USUARIO", "GOOGLE_TRANSLATE",
     * "DEEPL", "IMPORTADA"
     */
    @ColumnInfo(name = "fuente") val fuente: String = "USUARIO",

    /** ID del usuario que contribuyó la traducción (si es fuente USUARIO) */
    @ColumnInfo(name = "id_traductor_usuario") val idTraductorUsuario: Int? = null,

    /** Si fue verificada por moderadores o fuente confiable */
    @ColumnInfo(name = "verificada") val verificada: Boolean = false,

    /** Puntuación de confiabilidad 0-100 Basada en: fuente, verificación, votos, reportes */
    @ColumnInfo(name = "confiabilidad") val confiabilidad: Int = 0,

    // ==================== COMUNIDAD ====================

    /** Votos positivos - votos negativos */
    @ColumnInfo(name = "votos") val votos: Int = 0,
    @ColumnInfo(name = "reportes_error") val reportesError: Int = 0,

    // ==================== SINCRONIZACIÓN ====================

    /** Formato de sincronización si aplica Valores: "NONE", "LRC", "SRT" */
    @ColumnInfo(name = "formato_sincronizacion") val formatoSincronizacion: String = "NONE",
    ...
    @ColumnInfo(name = "activa") val activa: Boolean = true, // Para soft delete
) {
    companion object {
        /** Idiomas soportados oficialmente */
        val IDIOMAS_SOPORTADOS =
            mapOf(
                "es" to "Español",
                "en" to "English",
                "fr" to "Français",
        ...
        val FUENTES_CONFIABLES = listOf("GENIUS", "MUSIXMATCH", "DEEPL")
        ...
        fun esTraduccionPredeterminada(
            traduccion: LyricsTranslationEntity,
    ...
    fun actualizarContenido(nuevoTexto: String): LyricsTranslationEntity {
        return copy(
    ...
    fun agregarVoto(positivo: Boolean): LyricsTranslationEntity {
    ...
    fun agregarReporte(): LyricsTranslationEntity {
