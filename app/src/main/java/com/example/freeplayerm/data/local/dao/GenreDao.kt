...
/**
 * DAO para operaciones de géneros musicales en la base de datos. ✅ CORREGIDO - Campos sincronizados
 * con GenreEntity
 */
@Dao
interface GenreDao {
    ...
    suspend fun insertarGeneroSiNoExiste(genero: GenreEntity): Long
    ...
    suspend fun obtenerGeneroPorId(id: Int): GenreEntity?

    @Query("SELECT * FROM generos WHERE id_genero = :id LIMIT 1")
    fun obtenerGeneroPorIdFlow(id: Int): Flow<GenreEntity?>

    @Query("SELECT * FROM generos ORDER BY nombre ASC")
    fun obtenerTodosLosGeneros(): Flow<List<GenreEntity>>

    @Query("SELECT * FROM generos ORDER BY nombre ASC")
    suspend fun obtenerTodosLosGenerosSync(): List<GenreEntity>

    @Query("SELECT COUNT(*) FROM generos") suspend fun contarGeneros(): Int

    @Query("SELECT COUNT(*) FROM generos") fun contarGenerosFlow(): Flow<Int>
    ...
    fun buscarGeneros(query: String, limite: Int = 50): Flow<List<GenreEntity>>
    ...
    suspend fun buscarGeneroPorNombreExacto(nombre: String): GenreEntity?
    ...
    suspend fun buscarGeneroPorNombreNormalizado(nombreNormalizado: String): GenreEntity?
    ...
    fun obtenerGenerosPrincipales(): Flow<List<GenreEntity>>
    ...
    fun obtenerSubgeneros(padreId: Int): Flow<List<GenreEntity>>
    ...
    suspend fun obtenerSubgenerosSync(padreId: Int): List<GenreEntity>
    ...
    @Transaction
    suspend fun obtenerJerarquiaCompleta(generoId: Int): List<GenreEntity> {
        val resultado = mutableListOf<GenreEntity>()
    ...
    suspend fun obtenerGeneroPadre(generoId: Int): GenreEntity?
    ...
    fun obtenerGenerosPopulares(limite: Int = 20): Flow<List<GenreEntity>>
    ...
    fun obtenerGenerosMasCanciones(limite: Int = 20): Flow<List<GenreEntity>>
    ...
    fun obtenerGenerosMasEscuchados(limite: Int = 20): Flow<List<GenreEntity>>
    ...
    fun obtenerGenerosRecientes(limite: Int = 20): Flow<List<GenreEntity>>
    ...
    fun obtenerGenerosMayorPromedioReproduccionesPorCancion(
        limite: Int = 20
    ...
    suspend fun obtenerGenerosConNombresNoNormalizados(): List<GenreEntity>
    ...
    @Transaction
    suspend fun insertarOActualizarGenero(genero: GenreEntity): Long { // Cambiar a Long
    ...
    @Transaction
    suspend fun obtenerOCrearGenero(nombre: String, padreId: Int? = null): GenreEntity {
            ...
            ?: run {
                val nuevoGenero =
                    GenreEntity(
                        ...
                        color = GenreEntity.obtenerColorSugerido(nombre),
                        emoji = GenreEntity.obtenerEmojiSugerido(nombre),
                    )
    ...
    @Transaction
    suspend fun obtenerRutaHastaRaiz(generoId: Int): List<GenreEntity> {
        val ruta = mutableListOf<GenreEntity>()
