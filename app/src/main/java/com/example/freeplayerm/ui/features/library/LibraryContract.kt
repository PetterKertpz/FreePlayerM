...
data class BibliotecaEstado(
   ...
   val esModoSeleccionListas: Boolean = false,
   val listasSeleccionadas: Set<Int> = emptySet(),
   val listaParaEditar: PlaylistEntity? = null,
...
sealed interface BibliotecaEvento {
   ...
   data object DesactivarModoSeleccionListas : BibliotecaEvento
   
   data class AlternarSeleccionLista(val listaId: Int) : BibliotecaEvento
   
   data object SeleccionarTodasLasListas : BibliotecaEvento
   
   data object EliminarListasSeleccionadas : BibliotecaEvento
   
   data class AbrirDialogoEditarListaSeleccionada(val lista: PlaylistEntity) : BibliotecaEvento
   
   data object CerrarDialogoEditarListaSeleccionada : BibliotecaEvento
   
   data class GuardarCambiosListaSeleccionada(
      val nombre: String,
