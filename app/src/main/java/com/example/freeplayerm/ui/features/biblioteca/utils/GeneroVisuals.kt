package com.example.freeplayerm.ui.features.biblioteca.utils

import androidx.annotation.DrawableRes
import com.example.freeplayerm.R

object GeneroVisuals {
    ...
    @DrawableRes
    private val defaultImage = R.mipmap.defaultgenero

    /**
     * Devuelve el ID del recurso drawable para un nombre de género dado.
     * Normaliza el nombre para que no importen mayúsculas o acentos.
     */
    @DrawableRes
    fun getImageForGenre(genreName: String): Int {
        val normalizedName = genreName.lowercase()
