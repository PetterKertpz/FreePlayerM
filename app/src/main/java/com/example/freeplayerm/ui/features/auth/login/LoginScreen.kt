...
import com.example.freeplayerm.ui.features.auth.components.BotonGooglePulsante
import com.example.freeplayerm.ui.features.auth.components.CampoEntradaLogin
import com.example.freeplayerm.ui.features.auth.components.EncabezadoLogoAnimado
import com.example.freeplayerm.ui.features.auth.components.GalaxyBackground
import com.example.freeplayerm.ui.features.auth.components.TextoIniciarSesion
...
fun ContenidoPantallaLogin(
   ...
   Scaffold(
      ...
      Column(
         ...
         EncabezadoLogoAnimado(modifier = Modifier.fillMaxWidth(0.50f))
