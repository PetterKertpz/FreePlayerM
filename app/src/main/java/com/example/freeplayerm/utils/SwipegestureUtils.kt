...
/**
 * Orden lógico de navegación entre secciones
 * El usuario puede deslizar izquierda/derecha para moverse en este orden
 */
val ORDEN_NAVEGACION_SECCIONES = listOf(
...
/**
 * Verifica si se puede navegar con gestos desde la sección actual
 * Secciones de detalle (como CANCIONES_DE_ALBUM) no permiten navegación por gestos
 */
...
/**
 * Versión alternativa que detecta swipes con acumulación de distancia
 * Más precisa para gestos largos
 */
