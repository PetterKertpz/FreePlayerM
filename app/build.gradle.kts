...
dependencies {
    ...
    // --- Dependencias para la Base de Datos con Room ---
    val roomversion = "2.7.2"

    implementation(libs.androidx.room.runtime.v272)
    annotationProcessor(libs.androidx.room.compiler.v272)

// Para usar 'suspend' (Coroutines) en nuestros DAOs, añadimos esta dependencia opcional
    implementation(libs.androidx.room.ktx.v272)

// Para el procesador de anotaciones en Kotlin (si no está ya)
